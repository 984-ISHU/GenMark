...
import { ArrowLeft, Edit3, FileText, Image, ArrowDownToLine, Copy, Mail } from "lucide-react";
...
const Preview = () => {
  ...
  return (
    <div className="min-h-screen w-screen bg-gradient-to-br from-purple-200 via-pink-100 to-indigo-100 font-sans p-6 overflow-auto">
      ...
      {/* Edit Section */}
      <div className="mb-12">
        <h3 className="text-2xl font-semibold text-gray-800 mb-6 px-10">Edit Content</h3>
