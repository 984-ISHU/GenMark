...
export const checkFilteredDatasetExists = (user_id, project_id) =>
  API.get("/datasets/check-filtered-exists", {
    params: { user_id, project_id },
  });

export const getFilteredDataset = (user_id, project_id) =>
  API.get("/datasets/filtered-data", {
    params: { user_id, project_id },
  });
...
export const createProjectFormData = (projectData) => {
  ...
  formData.append("selected_dataset", projectData.selectedDataset);
