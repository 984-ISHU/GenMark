...
def generate_prompt(state: AgentState) -> dict:
    ...
    system_prompt = (
        ...
        "- The background should be realated to the specified location.\n"
        "- If a discount is 0, do not include a discount in the image (e.g., price tag overlay), otherwise diaplay it in a small box.\n\n"
        "**Text Prompt Rules:**\n"
